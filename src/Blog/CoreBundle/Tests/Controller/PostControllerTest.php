...
class PostControllerTest extends WebTestCase
{
    ...
    public function testShow()
    {
        ...
        $this->assertTrue($client->getResponse()->isSuccessful(), 'The respose was not successful');
    ...
    public function testCreateComment()
    {
        ...
        $this->assertTrue(
            $client->getResponse()->isRedirect('/'.$post->getSlug()), 'There was no redirection after submittin the post'
        );
